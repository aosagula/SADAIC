    ...
    <aside id="side_bar" class=" d-md-block">
        <nav id="navmain" data-simplebar>
            <ul class="menu">
                <li class="user sub-menu pl-4">
                    <div
                        ...
                        <div id="userWrap" class="d-flex flex-column"
                            ...
                            <div class="pt-md-4 d-flex flex-column">
                                <span class=" d-lg-inline-block text-nav title-nav"> ¡Hola </span>
                                <span class="name-user d-lg-inline-block text-nav title-nav"> Nombre Usuario! </span>
                            </div>
                            <div class="d-flex align-items-center">
                                <img class=" mb-2 d-inline-block text-nav" src="/images/icon-config.svg" alt="Mi cuenta"
                                    width="10px">
                                <span class=" ml-2 mb-1  d-sm-inline-block text-nav title-nav"> Mi Cuenta </span>
                            </div>
                        </div>
                    </div>
                    <ul class="sub-items">
                ...
                <li><a href="/member/"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                            <use class="icon-svg" xlink:href="#inicio"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Inicio </span></a> </li>

                <li><a href="/member/password/update"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                    <use class="icon-svg" xlink:href="#cuenta"></use>
                </svg> <span class=" text-nav d-md-inline-block"> Cambiar clave </span></a> </li>

                <li><a href="/member/profile/update"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                    <use class="icon-svg" xlink:href="#cuenta"></use>
                </svg> <span class=" text-nav d-md-inline-block"> Actualizar datos </span></a> </li>

                <li><a href="/member/status"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                            <use class="icon-svg" xlink:href="#cuenta"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Estado de cuenta </span></a> </li>

                <li><a href="/member/work/list"> <svg class="nav-icon mr-3" viewBox="0 0 50 62.5">
                            <use class="icon-svg" xlink:href="#obras"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Mis obras </span></a> </li>

                <li><a href="/member/work/register"> <svg class="nav-icon mr-3" viewBox="0 0 512 640">
                            <use class="icon-svg" xlink:href="#registro"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Registro de Obras </span></a> </li>

                <li><a href="#"> <svg class="nav-icon mr-3" viewBox="0 0 512 640">
                            <use class="icon-svg" xlink:href="#registro"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Registro de Solicitud de Inclusión </span></a>
                </li>

                <li><a href="dashboard-registro-digital.html"> <svg class="nav-icon mr-3" viewBox="0 0 512 640">
                            <use class="icon-svg" xlink:href="#registro"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Registro Digital de Obra de Música en
                            Publicidad </span></a> </li>

                <li><a href="/member/international-performance/report"> <svg class="nav-icon mr-3" viewBox="0 0 52 65">
                            <use class="icon-svg" xlink:href="#informe"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Informe de actuación en el exterior
                        </span></a> </li>

                <li><a href="/member/payment-letters"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                            <use class="icon-svg" xlink:href="#aportes"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Cartas de pago </span></a> </li>

                <li><a href="/member/payment-orders"> <svg class="nav-icon mr-3" viewBox="0 0 90 90">
                            <use class="icon-svg" xlink:href="#aportes"></use>
                        </svg> <span class=" text-nav d-md-inline-block"> Ordenes de pago </span></a> </li>

                <li><a href="/member/payment-request"> <svg class="nav-icon mr-3" viewBox="0 0 512 512">
                            <use class="icon-svg" xlink:href="#aportes"></use>
