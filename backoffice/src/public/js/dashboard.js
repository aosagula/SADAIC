...
module.exports=factory(function(){try{return __webpack_require__(/*! moment */"./node_modules/moment/moment.js");}catch(e){}}());
...
leftForLtr:function leftForLtr(x,_itemWidth){// eslint-disable-line no-unused-vars
return x;
}};
...
_inRange(vm,mouseX,null):
_inRange(vm,null,mouseY);
},
...
(function(global,factory){
factory(__webpack_require__(/*! ../moment */"./node_modules/moment/moment.js"));
})(this,function(moment){
...
/*!***********************************!*\
  ...
  \***********************************/
/*! no static exports found */
/***/function resourcesJsDashboardJs(module,exports,__webpack_require__){
...
type:'line',
data:{
labels:worksDays.map(function(e){
return e.created;
}),
datasets:[{
label:'Nuevas Solicitudes',
data:worksDays.map(function(e){
return e.count;
}),
fill:false}]},
...
data:{
datasets:[{
data:worksStatus.slice(0,-1).map(function(e){
return e.count;
}),
backgroundColor:['rgba(255, 99, 132, 0.2)','rgba(54, 162, 235, 0.2)','rgba(255, 206, 86, 0.2)','rgba(75, 192, 192, 0.2)','rgba(153, 102, 255, 0.2)','rgba(255, 159, 64, 0.2)'],
label:'Dataset 1'}],

labels:worksStatus.slice(0,-1).map(function(e){
return e.name;
})},
