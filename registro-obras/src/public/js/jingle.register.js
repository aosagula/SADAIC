...
/***/function node_modulesCurrencyJsDistCurrencyMinJs(module,exports,__webpack_require__){
...
*/
(function(e,g){module.exports=g();})(this,function(){function e(b,a){if(!(this instanceof e))return new e(b,a);a=Object.assign({},m,a);var d=Math.pow(10,a.precision);this.intValue=b=g(b,a);this.value=b/d;a.increment=a.increment||1/d;a.groups=a.useVedic?n:p;this.s=a;this.p=d;}function g(b,a){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:!0;var c=a.decimal;
var h=a.errorOnInvalid,k=a.fromCents,l=Math.pow(10,a.precision),f=b instanceof e;if(f&&k)return b.intValue;if("number"===typeof b||f)c=f?b.value:b;else if("string"===typeof b)h=new RegExp("[^-\\d"+c+"]","g"),c=new RegExp("\\"+c,"g"),c=(c=b.replace(/\((.*)\)/,"-$1").replace(h,"").replace(c,"."))||0;else {if(h)throw Error("Invalid Input");c=0;}k||(c=(c*l).toFixed(4));return d?Math.round(c):c;}var m={symbol:"$",separator:",",decimal:".",errorOnInvalid:!1,precision:2,pattern:"!#",negativePattern:"-!#",format:function format(b,
a){var d=a.pattern,c=a.negativePattern,h=a.symbol,k=a.separator,l=a.decimal;a=a.groups;var f=(""+b).replace(/^-/,"").split("."),q=f[0];f=f[1];return (0<=b.value?d:c).replace("!",h).replace("#",q.replace(a,"$1"+k)+(f?l+f:""));},fromCents:!1},p=/(\d)(?=(\d{3})+\b)/g,n=/(\d)(?=(\d\d)+\d\b)/g;e.prototype={add:function add(b){var a=this.s,d=this.p;return e((this.intValue+g(b,a))/(a.fromCents?1:d),a);},subtract:function subtract(b){var a=this.s,d=this.p;return e((this.intValue-g(b,a))/(a.fromCents?1:d),a);},multiply:function multiply(b){var a=
this.s;return e(this.intValue*b/(a.fromCents?1:Math.pow(10,a.precision)),a);},divide:function divide(b){var a=this.s;return e(this.intValue/g(b,a,!1),a);},distribute:function distribute(b){var a=this.intValue,d=this.p,c=this.s,h=[],k=Math[0<=a?"floor":"ceil"](a/b),l=Math.abs(a-k*b);for(d=c.fromCents?1:d;0!==b;b--){var f=e(k/d,c);0<l--&&(f=f[0<=a?"add":"subtract"](1/d));h.push(f);}return h;},dollars:function dollars(){return ~~this.value;},cents:function cents(){return ~~(this.intValue%this.p);},format:function format(b){var a=this.s;return "function"===
typeof b?b(this,a):a.format(this,Object.assign({},a,b));},toString:function toString(){var b=this.s,a=b.increment;return (Math.round(this.intValue/this.p/a)*a).toFixed(b.precision);},toJSON:function toJSON(){return this.value;}};return e;});
...
/*!********************************************************!*\
  ...
  \********************************************************/
/*! no static exports found */
/***/function node_modulesFormdataPolyfillFormdataMinJs(module,exports,__webpack_require__){
...
if("undefined"!==typeof Blob&&("undefined"===typeof FormData||!FormData.prototype.keys)){var L=function L(a,c){for(var b=0;b<a.length;b++){c(a[b]);}},M=function M(a,c,b){return c instanceof Blob?[String(a),c,void 0!==b?b+"":"string"===typeof c.name?c.name:"blob"]:[String(a),String(c)];},N=function N(a,c){if(a.length<c)throw new TypeError(c+" argument required, but only "+a.length+" present.");},O=function O(a){var c=v(a);a=c.next().value;var b=c.next().value;c=c.next().value;b instanceof Blob&&(b=new File([b],
...
/***/"./resources/js/jingle.register.js":
/*!*****************************************!*\
  !*** ./resources/js/jingle.register.js ***!
  \*****************************************/
/*! no static exports found */
/***/function resourcesJsJingleRegisterJs(module,exports,__webpack_require__){
...
var CustomStorage=__webpack_require__(/*! ./storage */"./resources/js/storage.js").PeopleStorage;
...
var userType=window.location.pathname.split('/')[1];
var requestOptions=[[{
id:1,
name:'Aviso Original'},
{
...
var personSearchResults=[];
var personSelected=null;// Campos excluidos del submit

var excludedFields=['ad_number'];// Función auxiliar para convertir la
...
$('#ad_details_territory_states').select2();// Selección de trámite regular / especial

$('input[name="is_special"]').on('change',function(){
var options=requestOptions[$(this).val()];
$('#request_action_id').empty();
options.forEach(function(option){
$('#request_action_id').append("<option value=\"".concat(option.id,"\">").concat(option.name,"</option>"));
});
...
$('select[name="request_action_id"]').change();// Selección de cantidad de avisos en campañas especiales

$('#ad_number').on('change',function(event){
var newAmmount=$(event.target).val();
var currentAmmount=$('.ads_duration:enabled').length;// Validación
...
var deleteAmmount=newAmmount-currentAmmount;
$('.ads_durationWrapper').slice(deleteAmmount).remove();// Más avisos que antes
}else if(newAmmount>currentAmmount){
for(var i=currentAmmount;i<newAmmount;i++){
var $newWrapper=$('.ads_durationWrapper').first().clone();
$newWrapper.val(1);
$('label',$newWrapper).text("Aviso ".concat(i+1));
...
$('#advertiser_email, #agency_email, #applicant_email').mask("A",mailMaskOptions).on('blur',function(event){
...
$('#broadcast_territory_id').change();// Acuerdo de autores
...
$('input[name="authors_agreement"]:checked').change();// Tarifa
...
var value=currency($(this).val()).value;
...
$('#payer').change();// Tabla de derechohabientes
...
var $results=$('#memberSearchResults');
$results.empty();
personSearchResults=[];
...
$.ajax({
url:"/".concat(userType,"/work/search_author"),
method:'POST',
dataType:"json",
data:{
...
var data=_ref.responseJSON;
personSearchResults=data;

if(data.length){
$results.append("<h3>".concat(data.length," socios encontrado(s):</h3>"));
var $resultsList=$('<ul></ul>');
$resultsList.empty();
$results.append($resultsList);// Parseamos los resultados

data.forEach(function(member){
var item="<a href=\"#\" class=\"selectPerson\" data-id=\"".concat(member.codanita,"\">");
item+="<span class=\"capitalize\">".concat(member.nombre.toLowerCase(),"</span>");
item+="</a></li>";

if(member.codanita){
item="<li>Socio #<strong>".concat(member.codanita,"</strong>: ")+item;
}else {
item="<li>"+item;
}
...
event.preventDefault();
personSelected=personSearchResults.find(function(m){
return m.codanita==$(_this).data('id');
});
$peopleTable.row.add(["<span class=\"capitalize\">".concat(personSelected.nombre.toLowerCase(),"</span>"),"".concat(personSelected.num_doc),"".concat(personSelected.codanita),"<button type=\"button\" class=\"btn btn-link removePerson\"><i class=\"far fa-trash-alt\"></i></button>",""]).node().id=personSelected.idx;
$peopleTable.draw();
...
event.preventDefault();// Convertimos la información del formulario en un objeto

var personSelected={};
$('#noMemberForm').serializeArray().forEach(function(e){
personSelected[e.name]=e.value;
});// Insertamos el nuevo registro en la tabla

$peopleTable.row.add(["<span class=\"capitalize\">".concat(personSelected.name.toLowerCase(),"</span>"),"".concat(personSelected.doc_number),"","<button type=\"button\" class=\"btn btn-link removePerson\"><i class=\"far fa-trash-alt\"></i></button>","<button type=\"button\" class=\"btn btn-link editPerson\" data-toggle=\"modal\" data-target=\"#editPersonModal\"><i class=\"far fa-edit\"></i></button>"]).node().id=personSelected.doc_number;
$peopleTable.draw();// Guardamos en el storage

customStorage.addPerson(_objectSpread({
type:'no-member'},
personSelected));// Escondemos el modal

$('#addPersonModal').modal('hide');// Seleccionamos la pestaña de socios
...
var row=$target.parents('tr').get(0);
var $row=$peopleTable.row(row);
var docNumber=$peopleTable.cell({
row:$row.index(),
column:1}).
data();
var memberId='';
var person=customStorage.getPerson(docNumber,memberId);
var $form=$('#editNoMemberForm');
...
event.preventDefault();// Recuperamos el nro de documento y los demás datos del storage de la persona a actualizar

var oldDocNumber=$peopleTable.cell({
row:currentRow,
column:1}).
data();// Recuperamos los datos de la persona a modificar

var personSelected=customStorage.getPerson(oldDocNumber,'');// Actualizamos los datos con lo ingresado en el formulario

$('#editNoMemberForm').serializeArray().forEach(function(e){
personSelected[e.name]=e.value;
});// Actualizamos el storage

customStorage.updatePerson(oldDocNumber,'',personSelected);// Actualizamos la tabla

$peopleTable.cell({
row:currentRow,
column:0}).
data("<span class=\"capitalize\">".concat(personSelected.name.toLowerCase(),"</span>"));
$peopleTable.cell({
row:currentRow,
column:1}).
data("".concat(personSelected.doc_number));// Escondemos el modal

$('#editPersonModal').modal('hide');// Reseteamos el form

$('#editNoMemberForm').trigger("reset");
});// Quitar personas

$('#peopleTable').on('click','.removePerson',function(event){
$(event.currentTarget).attr('disabled',true);
var row=$(event.target).parents('tr').get(0);
var idx=$peopleTable.row(row).index();
var memberId=$peopleTable.cell({
row:idx,
column:2}).
data();
var docNumber=$peopleTable.cell({
row:idx,
column:1}).
data();// Si tiene una distribución asociada (ya fue guardado) la eliminamos

customStorage.getPerson(docNumber,memberId);// Quitamos el dato del storage

customStorage.removePerson(docNumber,memberId);// Quitamos el row de la tabla

$peopleTable.row(row).remove().draw();
});// Guardar borrador

$('#saveRegister').on('click',function(event){
var $buttton=$(event.target);
$buttton.attr('disabled',true);// Elegimos el método en función de si ya se hizo un envío previo o no

var method='POST';
var url="/".concat(userType,"/jingles/");

if(customStorage.getField('id')){
method='PUT';
url="/".concat(userType,"/jingles/").concat(customStorage.getField('id'));
}// Parche IE11
...
var data=_ref2.data;
// Guardamos el id
customStorage.setField('id',data.id);// Reemplazamos la página de creación por la de edición

history.replaceState(null,'',"/".concat(userType,"/jingles/").concat(data.id,"/edit"));// Mostramos mensaje
...
for(var attr in response.data.errors){
...
var formData=serializeForm(document.getElementById('jingleRegistrationForm'));
...
if(key=='territory_id[]'){
value=$('#ad_details_territory_states').select2('data').map(function(e){
return e.id;
});
}else {
value=$(".".concat(key.slice(0,-2),":enabled")).get().map(function(e){
return e.value;
});
}
...
if(key.slice(-2)=='[]'){
var _value=$(".".concat(key.slice(0,-2),":enabled")).get().map(function(e){
return e.value;
});

customStorage.setField(key.slice(0,-2),_value);
continue;
}
...
$('#jingleRegistrationForm :input:checkbox:not(:checked)').each(function(idx,e){
...
event.stopPropagation();// Si el campo modificado es el CUIT, antes de cambiarlo nos aseguramos de
...
customStorage.setField(event.target.name,currency($(event.target).val()).value);
return;
...
event.stopPropagation();// Guardamos el campo actualizado en el storage
...
then(function(){
// Mostramos mensaje
toastr.success('Se envió correctamente la solicitud.');// Volvemos al listado (el form ya no se puede modificar)

window.location="/".concat(userType,"/jingles/");
...
return $(e).val($(e).val().split('-').reverse().join('/'));
...
/*!*********************************!*\
  !*** ./resources/js/storage.js ***!
  \*********************************/
/*! exports provided: default, PeopleStorage */
/***/function resourcesJsStorageJs(module,__webpack_exports__,__webpack_require__){
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"default",function(){return CustomStorage;});
/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"PeopleStorage",function(){return PeopleStorage;});
...
var storage=JSON.parse(localStorage.getItem(this.base));
var pattern=/\[\s*(\w+)\s*\]/g;

if(field.match(pattern)){
var subField=pattern.exec(field)[1];
...
var PeopleStorage=/*#__PURE__*/function(_CustomStorage){
_inherits(PeopleStorage,_CustomStorage);

var _super=_createSuper(PeopleStorage);

function PeopleStorage(base){
var _this;

var initial=arguments.length>1&&arguments[1]!==undefined?arguments[1]:[];

_classCallCheck(this,PeopleStorage);

_this=_super.call(this,base);

_this.setField('people',initial);

return _this;
}

_createClass(PeopleStorage,[{
key:"addPerson",
value:function addPerson(person){
var storage=this.getField('people');
storage.push(person);
this.setField('people',storage);
}},
{
key:"getPerson",
value:function getPerson(doc,member){
var storage=this.getField('people');
var idx=this.findPerson(doc,member);
...
{
key:"updatePerson",
value:function updatePerson(doc,member,person){
var storage=this.getField('people');
var idx=this.findPerson(doc,member);
...
{
key:"removePerson",
value:function removePerson(doc,member){
var storage=this.getField('people');
var idx=this.findPerson(doc,member);
...
{
key:"getPersonField",
value:function getPersonField(doc,member,field){
var person=this.getPerson(doc,member);
return person[field];
}},
{
key:"updatePersonField",
value:function updatePersonField(doc,member){
var person=this.getPerson(doc,member);
...
{
key:"findPerson",
value:function findPerson(doc_number,member_id){
var storage=this.getField('people');
var idx=-1;

if(doc_number!=''&&member_id!=''){
idx=storage.findIndex(function(e){
return e.doc_number==doc_number&&e.member_id==member_id;
});
}else if(doc_number!=''){
idx=storage.findIndex(function(e){
return e.doc_number==doc_number;
});
}else {
idx=storage.findIndex(function(e){
return e.member_id==member_id;
});
}
...
/***/5:
/*!***********************************************!*\
  !*** multi ./resources/js/jingle.register.js ***!
  \***********************************************/
/*! no static exports found */
/***/function _(module,exports,__webpack_require__){

module.exports=__webpack_require__(/*! /app/resources/js/jingle.register.js */"./resources/js/jingle.register.js");
