...
/***/"./resources/js/jingles.view.js":
/*!**************************************!*\
  !*** ./resources/js/jingles.view.js ***!
  \**************************************/
/*! no static exports found */
/***/function resourcesJsJinglesViewJs(module,exports){

$('#beginAction').on('click',function(){
axios.post("/jingles/".concat(jingleId,"/status"),{
status:'beginAction'}).
then(function(_ref){
var data=_ref.data;
...
axios.post("/jingles/".concat(jingleId,"/response"),{
response:'accept',
...
axios.post("/jingles/".concat(jingleId,"/observations"),{
...
/***/8:
/*!********************************************!*\
  !*** multi ./resources/js/jingles.view.js ***!
  \********************************************/
/*! no static exports found */
