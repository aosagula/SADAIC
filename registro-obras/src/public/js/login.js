...
/***/function node_modulesUrlPolyfillUrlPolyfillJs(module,exports,__webpack_require__){
...
/*!*******************************!*\
  ...
  \*******************************/
/*! no static exports found */
/***/function resourcesJsLoginJs(module,exports,__webpack_require__){

__webpack_require__(/*! url-polyfill */"./node_modules/url-polyfill/url-polyfill.js");// Transiciones


$('#loginMembers').on('click',function(){
window.location.hash="members";
});
$('#loginPlayers').on('click',function(){
window.location.hash="players";
});
$('#loginUsers').on('click',function(){
...
var $buttton=$(event.originalEvent.submitter);
$buttton.attr('disabled',true);
axios.post('/register',$('#formRegistration').serialize()).then(function(data){
...
$('#members form').on('submit',function(event){
var $buttton=$(event.originalEvent.submitter);
$buttton.attr('disabled',true);
axios.post('/login',$('#members form').serialize()).then(function(response){
...
$('#players form').on('submit',function(event){
var $buttton=$(event.originalEvent.submitter);
$buttton.attr('disabled',true);
axios.post('/login',$('#players form').serialize()).then(function(response){
if(response.data.status=='success'){
window.location=response.data.intended;
}else {
for(var attr in response.data.errors){
...
var $buttton=$(event.originalEvent.submitter);
$buttton.attr('disabled',true);
axios.post('/login',$('#users form').serialize()).then(function(response){
if(response.data.status=='success'){
window.location=response.data.intended;
}else {
for(var attr in response.data.errors){
